...
// let longitude = "$where=created_date between '' and ''";
// // Add the complaint type
// let latitude = "&complaint_type=";
// // Add a limit
// let maginitude = "&$limit=";
// let depth = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
